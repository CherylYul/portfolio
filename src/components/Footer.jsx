        ...
        <div className="center-container">
            ...
            <div className="footer--right">
                ...
                <div className="contact-container">
                    <div><i className="bi bi-github"></i><p>Github</p></div>
                    <div><i className="bi bi-linkedin"></i><p>LinkedIn</p></div>
                    <div><i className="bi bi-twitter"></i><p>Twitter</p></div>
                    <div><i className="bi bi-envelope"></i><p>Email</p></div>
                </div>
            </div>
        </div>
    </footer>
