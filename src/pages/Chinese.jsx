...
// import basicData from "../assets/chinese/basicData"

export default function Chinese(props) {
    // const [lectures, setLectures] = React.useState(basicData)

    // const lectureElements = lectures.map(lec => 
